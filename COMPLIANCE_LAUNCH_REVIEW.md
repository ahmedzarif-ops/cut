...
5. After those decisions, connect RevenueCat's separate App Store Connect API
   key, finish production configuration, run Apple Sandbox and TestFlight QA,
   and obtain explicit owner approval before Submit for Review.
