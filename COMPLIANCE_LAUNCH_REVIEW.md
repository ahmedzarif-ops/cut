...
the Paid Apps Agreement and bank account are still processing and counsel
review remains pending. The W-9 is active. Apple Developer Program membership,
Account Holder access, and the CUT OS app and subscription records are active.
...
| 2   | Confirm Apple Developer Program and App Store Connect authority      | Partly met | Active Individual membership, Account Holder access, and an active W-9 are evidenced. The owner accepted the Paid Apps Agreement; Apple still shows the agreement and bank account as processing. Wait for both to become active, then verify seller display. Counsel review remains open. |
