// Per-surface live-verify smoke battery for post-deploy checks. Zero-dep ESM.
...
export async function verifyUrl(url, surfaceType, expect = {}) {
  ...
  // image-200 checks (network — shell-only, mirrors the historical "all images 200" battery step).
