...
`build.js` creates the static Expo preview. Its Metro child process receives a
minimal environment from `build-environment.js`, not the server process's full
environment.
