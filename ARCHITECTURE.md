...
Deterministic product rules live in `lib/domain`. The first Next Action rule is
now active: onboarding → daily weigh-in → first balanced meal. Future daily
status, streak, adaptive-review, and fits-today rules follow the same boundary:
