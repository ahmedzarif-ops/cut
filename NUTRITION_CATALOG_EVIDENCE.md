...
formula and rounding policy from records in the FDC input registry above. The
automated evidence test asserts that every runtime template has an exact gram
recipe and reproduces its displayed nutrition.

“Desi-inspired” and “Bengali-inspired” are descriptive working labels for
simplified ingredient combinations, not authenticity, safety, or professional
approval claims. The added templates inherit every estimate, allergen,
cultural-review, legal-review, and medical-claim limitation in this ledger.

| Template ID                         | FDC inputs as `record: grams`                                                                                                                | Per-serving estimate                              |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| `desi-chicken-masoor-rice-bowl`     | `171477:150`; `172421:150`; `168878:100`; `170457:100`; `170000:50`; `171413:5`; `169230:5`; `169231:5`; `170923:1`; `172231:1`; `746775:1`  | 652 kcal; P 64.9 g; C 70.6 g; F 11.8 g; Fi 14.8 g |
| `desi-chicken-quinoa-sabzi-bowl`    | `171477:150`; `168917:140`; `168463:100`; `169292:100`; `170457:100`; `171413:5`; `169230:5`; `169231:5`; `170923:1`; `172231:1`; `746775:1` | 534 kcal; P 58.4 g; C 43.8 g; F 14.2 g; Fi 9.1 g  |
| `egg-masoor-spinach-plate`          | `173424:150`; `172421:200`; `168463:100`; `170457:100`; `170000:50`; `171413:5`; `169230:5`; `170923:1`; `172231:1`; `746775:1`              | 584 kcal; P 41.9 g; C 57.0 g; F 22.5 g; Fi 20.7 g |
| `bengali-salmon-rice-spinach`       | `175168:140`; `168878:140`; `168463:100`; `170457:100`; `170000:50`; `171413:5`; `169231:5`; `172231:1`; `746775:1`                          | 583 kcal; P 39.3 g; C 53.3 g; F 23.3 g; Fi 5.3 g  |
| `desi-tofu-masoor-bowl`             | `172475:150`; `172421:180`; `168463:75`; `170457:100`; `170000:50`; `171413:5`; `169230:5`; `170923:1`; `172231:1`; `746775:1`               | 539 kcal; P 46.4 g; C 54.5 g; F 19.5 g; Fi 22.0 g |
| `chicken-sweet-potato-masala-plate` | `171477:150`; `168483:220`; `169967:120`; `170457:100`; `170000:50`; `171413:5`; `169230:5`; `170923:1`; `172231:1`; `746775:1`              | 584 kcal; P 55.8 g; C 65.5 g; F 11.7 g; Fi 13.7 g |
| `masoor-brown-rice-sabzi-bowl`      | `172421:220`; `169704:100`; `168463:100`; `170457:100`; `170000:50`; `171413:5`; `169230:5`; `170923:1`; `172231:1`; `746775:1`              | 498 kcal; P 27.6 g; C 84.9 g; F 7.6 g; Fi 23.9 g  |
| `yogurt-oat-banana-bowl`            | `170894:250`; `173904:50`; `173944:100`; `170554:10`                                                                                         | 475 kcal; P 34.8 g; C 69.9 g; F 7.6 g; Fi 11.1 g  |
| `chicken-rice-kachumber-bowl`       | `171477:150`; `169704:140`; `168409:120`; `170457:100`; `169247:75`; `167747:20`; `171413:5`; `746775:1`                                     | 517 kcal; P 53.0 g; C 47.9 g; F 12.3 g; Fi 5.7 g  |
| `egg-quinoa-spinach-bowl`           | `173424:150`; `168917:150`; `168463:100`; `170457:100`; `170000:50`; `171413:5`; `170923:1`; `172231:1`; `746775:1`                          | 525 kcal; P 30.1 g; C 47.1 g; F 24.6 g; Fi 9.0 g  |
...
| `desi-chicken-masoor-rice-bowl`     | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `desi-chicken-quinoa-sabzi-bowl`    | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `egg-masoor-spinach-plate`          | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `bengali-salmon-rice-spinach`       | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `desi-tofu-masoor-bowl`             | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `chicken-sweet-potato-masala-plate` | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `masoor-brown-rice-sabzi-bowl`      | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `yogurt-oat-banana-bowl`            | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `N/A or required rationale`                | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `chicken-rice-kachumber-bowl`       | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `egg-quinoa-spinach-bowl`           | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `salmon-quinoa-vegetable-bowl`      | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `N/A or required rationale`                | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
| `tofu-edamame-quinoa-bowl`          | `[REQUIRED]`                                                                | `[REQUIRED]`                       | `[REQUIRED]`                                           | `[REQUIRED]`              | `[REQUIRED]`                               | `[REQUIRED]`                                                             | `[REQUIRED]` | `[REQUIRED]`                     |
