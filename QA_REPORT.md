...
| Password recovery                   | PASS (automated)   | Email-code reset handles Clerk result objects, keeps the request response account-enumeration-safe, validates the code, sets a new password, and exposes a sign-in fallback.         |
