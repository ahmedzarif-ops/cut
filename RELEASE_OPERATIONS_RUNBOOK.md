...
| `BUILD_SHA`                                                                                                                                                                                                                      | Non-secret deployed-revision identity             | Exact full lowercase SHA of the deployed development/staging candidate | Exact full lowercase SHA of the approved production candidate               | Prohibited; the mobile build records the same identity in release evidence                      |
...
pnpm run verify:deploy -- <STAGING_APP_ORIGIN>/status json-readiness --build-sha <BUILD_SHA>
...
9. Confirm the same application revision is running the exact
   ...
   ```sh
   pnpm run verify:deploy -- <PRODUCTION_APP_ORIGIN>/status json-readiness --build-sha <BUILD_SHA>
