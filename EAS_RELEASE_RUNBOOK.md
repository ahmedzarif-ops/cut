...
release. The owner-deferred professional-review decision in
`APP_STORE_READINESS.md` requires legal/privacy and nutrition review to be
initiated within three calendar days after public release and forbids any
professional-approval claim before a real review exists.
